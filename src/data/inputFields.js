...
export const FACULTY_CLASS_YEAR = "0'26"
import { Activity, Lightbulb, BookOpen, FileX, Tag, Search, MapPin, Trophy, Frown, GraduationCap, Cake, Heart, User, Phone, Briefcase, Star, Mail } from "lucide-react";
...
export const getFields = (course) => [
    ...
    {   key: "phone", label: "Phone No", placeholder: "0801 234 5678", icon: Phone },
    {   key: "email", label: "Email", placeholder: "ada@example.com", type: "email", icon: Mail },
    ...
    {   key: "best_at", label: "Best in", placeholder: "Making magic with 20% attendance", icon: Star },
    {   key: "career_path", label: "Career path", placeholder: "Software Engineer", icon: Briefcase },
